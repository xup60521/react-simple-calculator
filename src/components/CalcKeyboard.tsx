...
export default function CalcKeyboard({
    ...
    return <div className="w-full md:flex-grow-0 flex-grow grid grid-cols-4 md:p-8 p-6 bg-slate-800 rounded-xl text-black gap-4 md:gap-4 text-xl font-bold">
        ...
        <button onMouseDown={()=>handleInput("enter")} className={`col-span-2 flex items-center justify-center p-2 bg-white rounded-lg border-b-4 border-neutral-400 ${getColor(theme, "theme-enter-btn")}`}>=</button>
    </div>
}